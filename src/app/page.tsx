...
const dummyPosts: BlogPost[] = [
  {
    id: '1',
    title: 'Next.js 15의 새로운 기능들: App Router와 Server Components 완벽 가이드',
    excerpt: 'Next.js 15에서 도입된 혁신적인 기능들을 살펴보고, 실제 프로젝트에 어떻게 적용할 수 있는지 알아봅니다. 특히 App Router와 Server Components의 장점을 중심으로...',
  ...
  },
  {
    ...
    excerpt: '타입스크립트 5.0의 새로운 기능들과 함께 더욱 안전하고 생산적인 개발 환경을 구축하는 방법을 소개합니다.',
  ...
  },
  {
    ...
    excerpt: '현대적인 클라우드 네이티브 애플리케이션을 위한 컨테이너 오케스트레이션 전략과 실전 팁을 공유합니다.',
  ...
  },
  {
    ...
    excerpt: '5년간의 개발 여정을 돌아보며, 기술적 성장뿐만 아니라 소프트 스킬과 커리어 관리에 대한 인사이트를 나눕니다.',
